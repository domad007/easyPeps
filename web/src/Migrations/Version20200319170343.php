 ...
 */
final class Version20200319170343 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_FDCA8C9CF384C1CF ON cours (periode_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_FDCA8C9CF384C1CF ON cours');
