 ...
 */
final class Version20200322114201 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cours_evaluation (cours_id INT NOT NULL, evaluation_id INT NOT NULL, INDEX IDX_16DB575C7ECF78B0 (cours_id), INDEX IDX_16DB575C456C5646 (evaluation_id), PRIMARY KEY(cours_id, evaluation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
