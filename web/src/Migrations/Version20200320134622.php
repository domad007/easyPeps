 ...
 */
final class Version20200320134622 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cours_groupe ADD presences_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE cours_groupe ADD CONSTRAINT FK_6B399D497B8B9373 FOREIGN KEY (presences_id) REFERENCES presences (id)');
        $this->addSql('CREATE INDEX IDX_6B399D497B8B9373 ON cours_groupe (presences_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_6B399D497B8B9373 ON cours_groupe');
        $this->addSql('ALTER TABLE cours_groupe DROP presences_id');
    }
}
