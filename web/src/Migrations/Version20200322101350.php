 ...
 */
final class Version20200322101350 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE competences (id INT AUTO_INCREMENT NOT NULL, type_competence_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, degre INT NOT NULL, INDEX IDX_DB2077CE659BAA9E (type_competence_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
